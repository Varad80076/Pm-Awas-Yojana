                    ...
                    <form action="AddDealer" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4" class="input__label">Dealer Id</label>
                                <input type="text" class="form-control input-style" id="inputEmail4"
                                    placeholder="Dealer Id" name="Dealer Id" required>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputEmail4" class="input__label">Password</label>
                                <input type="password" class="form-control input-style" id="inputEmail4"
                                    placeholder="Password" name="Password" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputPassword4" class="input__label">Shop Name</label>
                                <input type="text" class="form-control input-style" id="inputPassword4"
                                    placeholder="Shop Name" name="Shop Name" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control input-style" id="inputZip" name="Zip">
                            </div>
                        ...
                        <button type="submit" class="btn btn-primary btn-style mt-4" onclick="location.href='Dealer.jsp'">submit</button>
                    </form>
                </div>
            </div>
            <!-- //forms 2 -->
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    try {
                        ...
                        PreparedStatement pstmt = con.prepareStatement("SELECT * FROM createdealer_tbl");
                    ...
                    <tr>
                        ...
                        <td><%= pincode %></td>
                        <td><%= status %></td>
                        <td><a href="Delete.jsp?Did=<%= dealerId %>" class="btn btn-danger btn-sm">Delete</a></td>
                        <td><a href="ApproveDealer.jsp?Did=<%= dealerId %>" class="btn btn-danger btn-sm">Approve</a></td>
                       <td><a href="Email_Service.jsp?Did=<%= dealerId %>&Email=<%= email %>&Password=<%= password %>" class="btn btn-danger btn-sm">send</a></td>
                        
                        <td><a href="DisApproveDealer.jsp?Did=<%= dealerId %>" class="btn btn-danger btn-sm">DisApprove</a></td>
                    </tr>
                    <% 
                        }
                        con.close();
