    ...
    <div class="container-fluid content-top-gap">
      ...
      <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb my-breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Submit Photo</li>
        </ol>
      </nav>
      <!-- //breadcrumbs -->
      <!-- cards -->
                    ...
                    <form action="AddUserPhoto" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4" class="input__label">U_id</label>
                                <input type="text" class="form-control input-style" id="inputEmail4"
                                    placeholder="User Id" name="U_id" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputPassword4" class="input__label">UserName</label>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    try {
                        ...
                        PreparedStatement pstmt = con.prepareStatement("SELECT * FROM userphoto_tbl");
                    ...
                    <tr>
                        ...
                        <td><%= username %></td>
                        <td><%= email %></td>
                         <td><a href="DisplayUserPhoto.jsp?U_id=<%= U_id %>" class="btn btn-danger btn-sm">Photo</a></td>
                        
                        <td><a href="Delete.jsp?u_id=<%= U_id %>" class="btn btn-danger btn-sm">Delete</a></td>
                        <td><a href="ApproveDealer.jsp?u_id=<%= U_id %>" class="btn btn-danger btn-sm">Approve</a></td>
                        <td><a href="DisApproveDealer.jsp?u_id=<%= U_id %>" class="btn btn-danger btn-sm">DisApprove</a></td>
                    </tr>
                    <% 
                        }
                        con.close();
