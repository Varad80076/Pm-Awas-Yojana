...
<%@ page import="com.avas.Getsetcomment" %>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><%= Email %></td>
                        <td><%= Complaint %></td>
                        <td><a href="Comment.jsp?email=<%= Email %>" class="btn btn-danger btn-sm">Comment</a></td>
                        <td><a href="DeleteComplaint.jsp?c_id=<%= c_id %>" class="btn btn-danger btn-sm">Delete</a></td>
                        <td><a href="editcomment.jsp?email=<%= Email %>" class="btn btn-danger btn-sm">View Comment</a></td>
