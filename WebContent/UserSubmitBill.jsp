      ...
      <ul class="nav nav-pills nav-stacked custom-nav">
        ...
        <li class="menu-list active">
          <a href="#"><i class="fa fa-file-text"></i>
            <span>Bill <i class="lnr lnr-chevron-right"></i></span></a>
          <ul class="sub-menu-list">
            <li><a href="UserSubmitBill.jsp">Submit Bill</a> </li>
            <li><a href="UserSubmitPhoto.jsp">Submit Photos</a> </li>
            
          </ul>
        </li>
        
        <li><a href="UserAddComplaint.jsp"><i class="fa fa-cogs"></i> <span>Complaint</span></a></li>
      </ul>
      <!-- //sidebar nav end -->
      <!-- toggle button start -->
      <a class="toggle-btn">
    ...
    <div class="container-fluid content-top-gap">
      ...
      <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb my-breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Submit bill</li>
        </ol>
      </nav>
      <!-- //breadcrumbs -->
      <!-- cards -->
      <section class="template-cards">
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="card-body">
                    <form action="DeleteBill.jsp" method="post">
                        <div class="card card_border py-2 mb-4">
    <div class="card-body">
        <h4>Material Bill</h4>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    try {
                        ...
                        PreparedStatement pstmt = con.prepareStatement("SELECT * FROM addbilldealer_tbl");
                        ResultSet rs = pstmt.executeQuery();
                        while (rs.next()) {
                            int bill_id = rs.getInt(1);
                            String username = rs.getString(2);
                            String material1 = rs.getString(3);
                            Long quantity1 = rs.getLong(5);
                            Long cost1 = rs.getLong(7);                           
                            String material2 = rs.getString(4);                                
                            Long quantity2 = rs.getLong(6);  
                            Long cost2 = rs.getLong(8);
                            Long total = rs.getLong(9);
                    ...
                    <tr>
                        ...
                        <td><a href="SubmitUserBill.jsp?bill_id=<%= bill_id %>" class="btn btn-danger btn-sm" onclick="location.href='ViewDealerBill.jsp'" >Submit</a></td>
                        <td><a href="UnSubmitUserBill.jsp?bill_id=<%= bill_id %>" class="btn btn-danger btn-sm" onclick="location.href='ViewDealerBill.jsp'" >UnSubmit</a></td>
                    </tr>
                    <% 
                        }
                        con.close();
                    ...
                    <button type="submit" class="btn btn-primary btn-style mt-4" onclick="location.href='AddDealerBill.jsp'">submit</button>
                </div>
            </div>
            <!-- //horizontal forms-->
