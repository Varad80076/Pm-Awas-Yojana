...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
  ...
  <style>
   body {
    background-image: url(Prdhan-Mantri-Awas-Yojana-2.png);
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center center;
  }
container-fluid content-top-gap
{
margin-top: 60px;
padding: 20px;
}
  ...
  <!-- if logo is image enable this -->
    ...
    <div class="sidebar-menu-inner">
      ...
      <ul class="nav nav-pills nav-stacked custom-nav">
        <li class="active"><a href="home.html"><i class="fa fa-tachometer" onclick="location.href='home.html'"></i><span> Dashboard</span></a>
        </li>
        <li class="menu-list">
...
<script>
    $(document).ready(function() {
        ...
        function sendEmail(email, password) {
            $.ajax({
                type: "POST",
                url: "EmailService", // Replace with the URL of your Java Servlet
                data: {
                    toEmail: email,
                    subject: "Test Email",
                    body: "Hello, this is a test email from JavaMail in Servlet."
                },
        ...
        // Attach click event to send buttons
