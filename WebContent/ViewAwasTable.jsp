      ...
      <section class="template-cards">
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="card-body">
                    <form action="deleteawas.jsp" method="post">
                        <div class="card card_border py-2 mb-4">
    <div class="card-body">
        <h4>Awas Information</h4>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    try {
                        ...
                        PreparedStatement pstmt = con.prepareStatement("SELECT * FROM addawas_tbl");
                    ...
                    <tr>
                        ...
                        <td><%= location %></td>
                        <td><%= region %></td>
                        <td><a href="DisplayPlanFile.jsp?aid=<%= aid %>" class="btn btn-danger btn-sm"  >Display Document</a></td>
                        <td><%= status %></td>
                        
                        <td><a href="deleteawas.jsp?aid=<%= aid %>" class="btn btn-danger btn-sm" onclick="location.href='ViewAwasTable.jsp'" >Delete</a></td>
                        <td><a href="ApproveAwas.jsp?aid=<%= aid %>" class="btn btn-danger btn-sm" onclick="location.href='ViewAwasTable.jsp'">Approve</a></td>
                        <td><a href="DisApproveAwas.jsp?aid=<%= aid %>" class="btn btn-danger btn-sm" onclick="location.href='ViewAwasTable.jsp'">DisApprove</a></td>
                    </tr>
                    <% 
                        }
                        con.close();
