            ...
            <ul>
              <li class="dropdown profile_details_drop">
                ...
                <ul class="dropdown-menu drp-mnu" aria-labelledby="dropdownMenu3">
                  ...
                  <li class="logout"> <a href="UserLogin.html"><i class="fa fa-power-off" onclick="location.href='SuperAdmin.html'"></i> Logout</a> </li>
                </ul>
              </li>
            </ul>
          </div>
    ...
    <div class="container-fluid content-top-gap">
      ...
      <section class="template-cards">
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="card-body">
                    <form action="AddComplaint" method="post">
                        ...
                        <div class="form-row">
                             <div class="form-group col-md-6">
                                <label for="inputEmail4" class="input__label">Complaint</label><br>
                                <textarea id="complaint" name="complaint" placeholder="Complaint" rows="5" col="12" required></textarea>
                            </div>
                          
                        </div>
                       
                        <button type="submit" class="btn btn-primary btn-style mt-4" onclick="location.href='UserAddComplaint.jsp'">submit</button>
                    </form>
                </div>
            </div>
            <!-- //forms 2 -->
            ...
            <!-- horizontal forms-->
            <h3>Dealer Table</h3>
<form action="DeleteComplaint.jsp"></form>
<div class="card card_border py-2 mb-4">
    <div class="card-body">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    try {
                        ...
                        PreparedStatement pstmt = con.prepareStatement("SELECT * FROM usercomplaint_tbl");
                        PreparedStatement pstmt1 = con.prepareStatement("SELECT comment  FROM comment_tbl");
                    ...
                    <tr>
                        ...
                        <td><%= Email %></td>
                        <td><%= Complaint %></td>
                        <td><a href="#.jsp?c_id=<%= c_id %>" class="btn btn-danger btn-sm">Comment</a></td>
                        <td><a href="DeleteComplaint.jsp?c_id=<%= c_id %>" class="btn btn-danger btn-sm">Delete</a></td>
