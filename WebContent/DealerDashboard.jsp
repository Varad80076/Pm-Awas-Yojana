  ...
  <!-- if logo is image enable this -->
    ...
    <div class="sidebar-menu-inner">
      ...
      <ul class="nav nav-pills nav-stacked custom-nav">
        <li class="active"><a href="DealerDashboard.jsp"><i class="fa fa-tachometer" onclick="location.href='DealerDashboard.jsp'"></i><span> Dashboard</span></a>
        </li>
        <li class="menu-list">
          <a href="#"><i class="fa fa-file-text"></i>
            <span>Bill <i class="lnr lnr-chevron-right"></i></span></a>
          <ul class="sub-menu-list">
            <li><a href="AddDealerBill.jsp">Add Bill</a> </li>
            <li><a href="ViewDealerBill.jsp">View Bill</a> </li>
          </ul>
        </li>
        ...
        <div class="user-dropdown-details d-flex">
          <div class="profile_details_left">
            <ul class="nofitications-dropdown">
              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"></i></a>
                <ul class="dropdown-menu">
                  <li>
                    <div class="notification_header">
                    </div>
...
<div class="main-content">
  ...
  <div class="container-fluid content-top-gap">
    ...
    <div class="welcome-msg pt-3 pb-4">
      <h1>Hi <span class="text-primary">varad</span>, Welcome back</h1>
      <p>Very detailed & featured Dealer.</p>
    </div>
...
<footer class="dashboard">
  <p>&copy 2020 Collective. All Rights Reserved | Design by <a href="https://w3layouts.com/" target="_blank"
      class="text-primary">Pm Awas Yojana</a></p>
</footer>
<!--footer section end-->
<!-- move top -->
